...
2	TaskID		The unique ID of the task that needs be imaged
...
15	PitchAngleList	A list of satellite pitch angles (separated by semicolons) per second in the VTW
16	RollAngleList	A list of satellite roll angles (separated by semicolons) per second in the VTW
17	YawAngleList	A list of satellite yaw angles (separated by semicolons) per second in the VTW
